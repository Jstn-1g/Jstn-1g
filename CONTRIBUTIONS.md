...
Eleven authored pull requests are merged. Thirteen changes are named in stable release notes:
...
| [v0.10.0](https://github.com/dsh-tauri-desk/deepseek-harness-desktop/releases/tag/v0.10.0) | Official-leaf recovery extraction and Node runtime compatibility aligned with DSH alpha | [#215](https://github.com/dsh-tauri-desk/deepseek-harness-desktop/pull/215), [#231](https://github.com/dsh-tauri-desk/deepseek-harness-desktop/pull/231) |
